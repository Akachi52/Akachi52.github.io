function showBottomForm(){
  ...
  let b1 = document.getElementById("pkgDesc");
  ...
  b1.style.border = "2px solid #1d1a3a";
  b1.style.backgroundColor = "#f3f8fa";  
...
function price(){
  ...
  const roomType = ("Date Night");  
  sessionStorage.setItem('roomType', roomType);  
}

function targetbnb(){
  window.location.href = "bnb.html";
}
