...
function guest() {
	var x =  document.getElementById("guest-p");
  ...
  function closeGuest(){
    var y = document.getElementById("guest-p");
    y.style.display = "none"
}
function blockCart() {
	var f =  document.getElementById("cover-btns");
        f.style.display = "block"
  }
  function unblockCart(){
    var g = document.getElementById("cover-btns");
